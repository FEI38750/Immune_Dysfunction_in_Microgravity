# Nichenet analyses following the step 3: 3_stimulated_PBMC_SC_analysis.r
...
niches = list(
  "PBMC_uG_niche" = list(
    "sender" = c("B memory_uG","B intermediate_uG","B naive_uG"),
    "receiver" = c("T_cell_uG")),
  "PBMC_1G_niche" = list(
    "sender" = c("B memory_1G","B intermediate_1G","B naive_1G"),
...
lfc_plot
ggsave("B2T_lfc_plot.pdf", width = 8, height = 16)
...
ggsave("B2T_exprs_activity_target_plot.pdf", width = 12, height = 10)
...
circos_output = make_circos_lr(prioritized_tbl_oi, colors_sender, colors_receiver)
ggsave("circos_output_B2T.pdf", width = 10, height = 10)
