...
To start from the reads count matrixes, both cellranger and MTD processed, we recommend to use desktop with 128GB RAM and 8 CPUs or HPC to run the scripts. (from step1: 1_Preprocess_the_count_matrix.r) </br>
