...
niches = list(
  "PBMC_uG_niche" = list(
    "sender" = c("CD14 Mono_uG","CD16 Mono_uG"),
    "receiver" = c("T_cell_uG")),
  "PBMC_1G_niche" = list(
    "sender" = c("CD14 Mono_1G","CD16 Mono_1G"),
...
lfc_plot
ggsave("Mono2T_lfc_plot.pdf", width = 8, height = 16)
...
ggsave("Mono2T_exprs_activity_target_plot.pdf", width = 12, height = 10)
...
circos_output = make_circos_lr(prioritized_tbl_oi, colors_sender, colors_receiver)
ggsave("circos_output_Mono2T.pdf", width = 10, height = 10)
